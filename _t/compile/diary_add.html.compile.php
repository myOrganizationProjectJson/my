...
<div id="diary_title"><?php echo lang('add'); ?><?php echo lang('diary'); ?></div>

<div id="add_box">
<form action="<?php echo DIARY_ROOT_REF; ?>index.php?m=diary&a=submitadd" method="post" submittype="ajax">
    <div class="clear">
        <div class="left">
        <?php echo lang('datetime'); ?>:
        <input type="text" class="text" name="datetime" style="cursor:pointer;" readonly="readonly" onfocus="WdatePicker()" check="require" warning="<?php echo lang('datetime_is_null'); ?>" value='<?php echo($today); ?>'/>
        </div>
